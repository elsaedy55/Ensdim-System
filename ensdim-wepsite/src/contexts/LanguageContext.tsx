...
const translations: Record<Language, any> = {
  en: {
    ...
    maturity: {
      ...
      subtitle: 'We shape the right solution around your current stage: are you building your foundation, starting digital transformation, or preparing to scale smarter?',
      stage1: 'Build',
    ...
    methodology: {
      ...
      step3Desc: 'We design the right solution for the problem: digital experience, follow-up, management visibility, or practical intelligence layer.',
  ...
  ar: {
    ...
    maturity: {
      ...
      subtitle: 'نحدد الحل المناسب حسب مرحلة عملك: هل تبدأ في البناء، أم تبدأ في التحول الرقمي، أم تستعد للنمو والتوسع بذكاء؟',
      stage1: 'بناء',
    ...
    methodology: {
      ...
      subtitle: 'في إنسديم، نبدأ بالإنصات لما يحدث داخل عملك: أين تتعطل المتابعة، كيف يتصرف العملاء، وما الذي يستهلك وقت الفريق؛ ثم نحوله إلى خريطة واضحة، تصميم مناسب، وحل رقمي يخدم النمو.',
      ...
      step3Desc: 'نصمم الحل المناسب للمشكلة: تجربة رقمية، متابعة، رؤية إدارية، أو طبقة ذكاء عملية.',
