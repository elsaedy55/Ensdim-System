...
const translations: Record<Language, any> = {
  en: {
    ...
    solutions: {
      ...
      solution1Title: 'Behavioral Customer Journeys',
      solution1Desc: 'Map how customers move from interest to decision, then remove friction from the journey.',
      solution1Includes: ['Journey mapping', 'Friction analysis', 'Conversion flows', 'Touchpoints'],
      solution1CTA: 'Explore Journey Solution',
      solution2Title: 'Conversion-Focused Digital Experiences',
      solution2Desc: 'Build websites, landing pages, booking flows, and portals designed to guide users toward action.',
      solution2Includes: ['Website & landing pages', 'Booking flows', 'Client portals', 'UX design'],
      solution2CTA: 'Explore Digital Experiences',
      solution3Title: 'Intelligent Follow-Up Systems',
      solution3Desc: 'Connect CRM, workflows, reminders, automation, and customer data into one clearer follow-up layer.',
      solution3Includes: ['CRM', 'Automation', 'Reminders', 'Customer data'],
      solution3CTA: 'Explore Follow-Up Systems',
      solution4Title: 'Operations & Growth Visibility',
      solution4Desc: 'Build dashboards, reports, and AI-assisted insights that show what is working and what needs action.',
      solution4Includes: ['Dashboards', 'Analytics', 'AI insights', 'Growth tracking'],
      solution4CTA: 'Explore Visibility Solutions',
      solution5Title: 'Automation Layers',
      solution5Desc: 'Reduce repetitive work and speed up response.',
      solution5CTA: 'Explore Automation Layers',
      solution6Title: 'AI for Practical Decisions',
      solution6Desc: 'Use intelligence to improve follow-up, insights, and performance.',
      solution6CTA: 'Explore AI Solutions',
      includes: 'INCLUDES',
    },
    sectors: {
  ...
  ar: {
    ...
    solutions: {
      ...
      solution1Title: 'رحلات عملاء مبنية على السلوك',
      solution1Desc: 'نرسم كيف ينتقل العميل من الاهتمام إلى القرار، ونقلل نقاط التردد في الطريق.',
      solution1Includes: ['رسم رحلة العميل', 'تحليل نقاط الاحتكاك', 'مسارات التحويل', 'نقاط التواصل'],
      solution1CTA: 'استكشف حل الرحلة',
      solution2Title: 'تجارب رقمية موجهة للتحويل',
      solution2Desc: 'نبني مواقع وصفحات هبوط وأنظمة حجز وبوابات رقمية تقود المستخدم نحو القرار.',
      solution2Includes: ['موقع وصفحات هبوط', 'أنظمة حجز', 'بوابات عملاء', 'تصميم تجربة المستخدم'],
      solution2CTA: 'استكشف التجارب الرقمية',
      solution3Title: 'أنظمة متابعة ذكية',
      solution3Desc: 'نربط CRM ومسارات العمل والتذكيرات والأتمتة وبيانات العملاء في طبقة متابعة واحدة.',
      solution3Includes: ['CRM', 'أتمتة', 'تذكيرات', 'بيانات العملاء'],
      solution3CTA: 'استكشف أنظمة المتابعة',
      solution4Title: 'رؤية أوضح للتشغيل والنمو',
      solution4Desc: 'لوحات متابعة وتقارير ومؤشرات مدعومة بالذكاء — لمعرفة ما يعمل وما يحتاج تدخلاً.',
      solution4Includes: ['لوحات تحكم', 'تحليلات', 'مؤشرات ذكية', 'تتبع النمو'],
      solution4CTA: 'استكشف حلول الرؤية',
      solution5Title: 'طبقات الأتمتة',
      solution5Desc: 'نقلل العمل المتكرر ونسرّع الاستجابة من خلال تدفقات تشغيل أذكى.',
      solution5CTA: 'استكشف الأتمتة',
      solution6Title: 'ذكاء عملي للقرارات',
      solution6Desc: 'نستخدم الذكاء لتحسين المتابعة، الرؤية، والأداء.',
      solution6CTA: 'استكشف حلول الذكاء',
      includes: 'يشمل',
    },
    sectors: {
