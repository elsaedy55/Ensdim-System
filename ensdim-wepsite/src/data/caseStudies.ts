...
export const caseStudies: CaseStudy[] = [
  {
    ...
    is_published: true,
    sort_order: 0,
    published_at: '2026-07-19T23:59:59.000Z',
    updated_at: '2026-07-19T23:59:59.000Z',
  ...
  },
  {
    ...
    image_url: '/case-studies/lemera-clinic-booking-crm/lemera-clinic-website-booking.jpg',
    gallery_images: [],
    demo_url: null,
  ...
  },
  {
    ...
    image_url: '/case-studies/triboo-travel-mvp/triboo-app-booking.jpg',
    gallery_images: [
      '/case-studies/triboo-travel-mvp/triboo-admin-dashboard.jpg',
    ],
    demo_url: null,
  ...
  },
  {
    ...
    image_url: '/case-studies/real-estate-sales-crm-saudi/real-estate-website-crm.jpg',
    gallery_images: [],
    demo_url: null,
  ...
  },
  {
    ...
    image_url: '/case-studies/multi-branch-retail-ecommerce-saudi/retail-store-homepage.jpg',
    gallery_images: [
      '/case-studies/multi-branch-retail-ecommerce-saudi/retail-sales-dashboard.jpg',
    ],
    demo_url: null,
  ...
  },
  {
    ...
    image_url: '/case-studies/ai-communication-follow-up-layer/ai-communication-dashboard.jpg',
    gallery_images: [],
    demo_url: null,
  ...
  },
  {
    ...
    image_url: '/case-studies/elnemr-group-real-estate-growth-strategy/elnemr-group-building.jpg',
    gallery_images: [],
    demo_url: null,
  ...
  {
    id: '10',
    slug: 'smart-fitness-app-sports-club-saudi-arabia',
    is_published: true,
    sort_order: 9,
    published_at: '2026-07-19T00:00:00.000Z',
    updated_at: '2026-07-19T00:00:00.000Z',

    title_en: 'Turning hesitant members into loyal customers and growth drivers',
    title_ar: 'من مشترك متردد إلى عميل ملتزم ومصدر نمو للنادي',
    sector_en: 'Saudi Arabia, Fitness & Sports Operations|Fitness App + Personalized Plans + Smart Nudging|Growth & Retention',
    sector_ar: 'السعودية، اللياقة البدنية والتشغيل الرياضي|تطبيق ذكي + خطط مخصصة + تذكيرات سلوكية|النمو والاحتفاظ',
    card_problem_en: 'High churn, weak add-on sales',
    card_problem_ar: 'تسرب مرتفع وضعف مبيعات المنتجات',
    card_solution_en: 'Smart app: personalized plans + in-app store',
    card_solution_ar: 'تطبيق ذكي بخطط مخصصة ومتجر داخلي',
    card_impact_en: '45% higher renewals, 60% more product sales',
    card_impact_ar: 'تجديد أعلى بـ 45% ومبيعات أعلى بـ 60%',
    outcome_en: 'How we helped a sports club chain in Saudi Arabia improve member commitment, increase renewal rates, and open a new revenue channel through a smart app that delivers personalized training plans, nutrition guidance, behavioral reminders, and in-app product recommendations.',
    outcome_ar: 'كيف ساعدنا سلسلة أندية رياضية في السعودية على تحسين التزام المشتركين، رفع معدلات التجديد، وفتح قناة إيرادات إضافية من خلال تطبيق ذكي يقدم خطط تدريب وتغذية مخصصة، تذكيرات سلوكية، ومتجرًا داخليًا بتوصيات مناسبة لكل مشترك.',
    image_url: '/case-studies/smart-fitness-app-sports-club-saudi-arabia/gym-app-screens.jpg',
    gallery_images: [],
    demo_url: null,

    snapshot: [
      { label_en: 'Client', label_ar: 'العميل', value_en: 'Sports club chain', value_ar: 'سلسلة أندية رياضية' },
      { label_en: 'Country', label_ar: 'الدولة', value_en: 'Saudi Arabia', value_ar: 'السعودية' },
      { label_en: 'Industry', label_ar: 'القطاع', value_en: 'Fitness and sports operations', value_ar: 'اللياقة البدنية والتشغيل الرياضي' },
      { label_en: 'Stage', label_ar: 'المرحلة', value_en: 'Growth / Retention and revenue optimization', value_ar: 'Growth / تحسين الاحتفاظ والإيرادات' },
      { label_en: 'Solution Type', label_ar: 'نوع الحل', value_en: 'Fitness App + Personalized Plans + Smart Nudging + In-App Store + Behavioral Recommendations', value_ar: 'تطبيق ذكي + خطط مخصصة + تذكيرات سلوكية + متجر داخلي + توصيات سلوكية' },
      { label_en: 'Goal', label_ar: 'الهدف', value_en: 'Reduce member churn, improve workout commitment, increase subscription renewals, and grow add-on product sales inside the club.', value_ar: 'تقليل تسرب المشتركين، تحسين الالتزام بالتمارين، رفع معدل تجديد الاشتراكات، وزيادة مبيعات المنتجات الإضافية داخل النادي.' },
    ],

    situation_en: 'The sports club chain was facing two connected problems: fast customer churn and weak add-on product sales. Members paid for high-value subscriptions, but after joining the club, many did not know where to start. They did not have a training plan that matched their level, a nutrition system based on their measurements and goals, or consistent follow-up that helped them stay committed. Over time, members felt frustrated, visited less often, and eventually stopped attending or did not renew. From the management side, trainers could not personally follow hundreds of members at scale. Product sales, such as supplements and sports tools, relied mostly on direct hard selling, which often pushed customers away instead of encouraging them to buy.',
    situation_ar: 'كانت سلسلة الأندية الرياضية تعاني من مشكلتين مرتبطتين: تسرب العملاء بعد فترة قصيرة من الاشتراك، وضعف مبيعات المنتجات الإضافية مثل المكملات والأدوات الرياضية. المشترك كان يدفع قيمة اشتراك مرتفعة، ثم يدخل النادي ولا يعرف من أين يبدأ. لا توجد خطة تدريب واضحة تناسب مستواه، ولا نظام غذائي مرتبط بهدفه وقياساته، ولا متابعة مستمرة تساعده على الالتزام. ومع مرور الوقت، يشعر المشترك بالإحباط، تقل زياراته، ثم يتوقف عن الحضور ولا يجدد اشتراكه. من ناحية الإدارة، كان من الصعب على المدربين متابعة مئات المشتركين بشكل شخصي. كما أن بيع المنتجات الإضافية كان يعتمد غالبًا على البيع المباشر والضغط، وهو ما كان يزعج بعض العملاء بدل أن يشجعهم على الشراء.',

    challengeIntro_en: 'The challenge was not only to hire more trainers. The club needed a digital experience that makes every member feel personally guided without adding operational pressure to the team.',
    challengeIntro_ar: 'التحدي لم يكن في زيادة عدد المدربين فقط، بل في بناء تجربة رقمية تساعد كل مشترك على الشعور بأنه يحصل على متابعة شخصية، دون مضاعفة العبء على فريق النادي.',
    challengeItems_en: [
      'High member churn after joining.',
      'Low workout commitment due to lack of clear plans.',
      'Difficulty following large numbers of members individually.',
      'Weak sales of add-on products inside the club.',
      'Reliance on direct selling that may irritate customers.',
      'No clear link between member goals and recommended products.',
      'Limited use of member data to improve retention and experience.',
      'High acquisition cost to replace members who do not renew.',
    ],
    challengeItems_ar: [
      'ارتفاع معدل تسرب المشتركين بعد الاشتراك.',
      'ضعف التزام بعض العملاء بالتمرين بسبب غياب خطة واضحة.',
      'صعوبة متابعة عدد كبير من المشتركين بشكل فردي.',
      'ضعف مبيعات المنتجات الإضافية داخل النادي.',
      'اعتماد البيع على أسلوب مباشر قد ينفر العملاء.',
      'غياب ربط واضح بين هدف المشترك والمنتجات المناسبة له.',
      'ضعف استغلال بيانات المشتركين في تحسين التجربة والاحتفاظ.',
      'ارتفاع تكلفة جذب عملاء جدد لتعويض غير المجددين.',
    ],

    builtIntro_en: 'We built a digital experience that supports members from the moment they join, turning the app into a personal guide, commitment tool, and smart sales channel.',
    builtIntro_ar: 'قمنا ببناء تجربة رقمية تساعد النادي على مرافقة المشترك منذ لحظة التسجيل، وتحوّل التطبيق إلى مدرب مساعد، أداة التزام، وقناة بيع ذكية.',
    builtSections: [
      {
        title_en: '1. Member App',
        title_ar: '1. تطبيق مخصص للمشتركين',
        lead_en: 'We designed an app that helps members start their journey inside the club with clarity instead of confusion.',
        lead_ar: 'صممنا تطبيقًا يساعد المشترك على بدء رحلته داخل النادي بطريقة واضحة بدل أن يشعر بالتشتت بعد الاشتراك.',
        items_en: [
          'Enter basic information.',
          'Add height, weight, goal, and experience level.',
          'Follow their training plan.',
          'See daily tasks.',
          'Track progress over time.',
          'Receive recommendations linked to their current goal.',
        ],
        items_ar: [
          'تسجيل بياناته الأساسية.',
          'إدخال الطول، الوزن، الهدف، ومستوى الخبرة.',
          'متابعة خطته التدريبية.',
          'معرفة المهام اليومية.',
          'متابعة تطوره بمرور الوقت.',
          'الوصول إلى توصيات مرتبطة بهدفه الحالي.',
        ],
      },
      {
        title_en: '2. Personalized Training and Nutrition Plans',
        title_ar: '2. خطط تدريب وتغذية مخصصة',
        lead_en: 'Once the member enters their data, the system generates a training plan suitable for their level and a nutrition plan calculated around their goal.',
        lead_ar: 'بمجرد إدخال بيانات المشترك، يقوم النظام بتوليد خطة تدريب مناسبة لمرحلته، ونظام غذائي محسوب حسب هدفه.',
        items_en: [
          'Reducing confusion at the beginning.',
          'Giving members a clear path to follow.',
          'Making the experience more personal.',
          'Increasing commitment to training.',
          'Reducing full dependency on trainers for daily follow-up.',
        ],
        items_ar: [
          'تقليل الحيرة في بداية الاشتراك.',
          'توجيه المشترك لخطوات واضحة.',
          'جعل التجربة أكثر شخصية.',
          'رفع احتمالية الالتزام بالتمارين.',
          'تقليل الاعتماد الكامل على المدرب في المتابعة اليومية.',
        ],
        closing_en: 'The goal was not to make the member think more. It was to give them a clear path to follow.',
        closing_ar: 'الفكرة لم تكن أن يفكر المشترك كثيرًا، بل أن يجد أمامه مسارًا واضحًا يمكنه اتباعه.',
      },
      {
        title_en: '3. Smart Nudging for Commitment',
        title_ar: '3. تذكيرات ذكية لبناء عادة الالتزام',
        lead_en: 'We added a smart reminder and guidance system that helps members stay committed to gym visits, meals, and training plans.',
        lead_ar: 'قمنا بإضافة نظام تذكير وتوجيه ذكي يساعد المشترك على الالتزام بزيارات الجيم والوجبات والخطة التدريبية.',
        items_en: [
          'Workout times.',
          'Daily plan steps.',
          'Meal reminders.',
          'Motivational messages based on commitment level.',
          'Alerts when activity drops.',
          'Positive reinforcement when progress is achieved.',
        ],
        items_ar: [
          'مواعيد التمرين.',
          'خطوات الخطة اليومية.',
          'تذكيرات الوجبات.',
          'رسائل تحفيزية حسب مستوى الالتزام.',
          'تنبيهات عند الانقطاع أو ضعف النشاط.',
          'تشجيع المشترك عند تحقيق تقدم واضح.',
        ],
        closing_en: 'This made members feel that they had continuous support, even outside the club.',
        closing_ar: 'هذا جعل المشترك يشعر أن هناك متابعة مستمرة، حتى خارج وقت وجوده داخل النادي.',
      },
      {
        title_en: '4. In-App Store with Smart Recommendations',
        title_ar: '4. متجر داخلي بتوصيات ذكية',
        lead_en: 'We integrated the club store inside the app in a way that does not rely on pushy selling, but on the right recommendation at the right time. When a member reaches a certain stage in their training plan or shows a need related to their goal, the app recommends suitable products such as supplements or sports tools.',
        lead_ar: 'قمنا بدمج متجر النادي داخل التطبيق بطريقة لا تعتمد على البيع الضاغط، بل على التوصية المناسبة في الوقت المناسب. عندما يصل المشترك إلى مرحلة معينة في خطته، أو يظهر احتياج مرتبط بهدفه، يقترح التطبيق منتجات مناسبة مثل مكملات غذائية أو أدوات رياضية مرتبطة بخطته الحالية.',
        items_en: [
          'Making purchases connected to real needs.',
          'Reducing customer resistance to direct selling.',
          'Increasing internal product sales.',
          'Making recommendations feel like part of the progress journey.',
          'Opening an additional revenue channel inside the app.',
        ],
        items_ar: [
          'جعل الشراء مرتبطًا باحتياج فعلي.',
          'تقليل مقاومة العميل للبيع المباشر.',
          'رفع مبيعات المنتجات الداخلية.',
          'جعل التوصية تبدو جزءًا من رحلة التطور، لا إعلانًا منفصلًا.',
          'فتح قناة إيرادات إضافية داخل التطبيق.',
        ],
      },
      {
        title_en: '5. Data for Management Decisions',
        title_ar: '5. بيانات تساعد الإدارة على تحسين التجربة',
        lead_en: 'Through the app, management gained clearer visibility into member commitment, activity, interaction with plans, and product sales.',
        lead_ar: 'من خلال التطبيق، أصبحت الإدارة قادرة على رؤية مؤشرات أوضح حول التزام المشتركين، نشاطهم، تفاعلهم مع الخطط، ومبيعات المنتجات.',
        items_en: [
          'Identifying less committed members.',
          'Finding intervention opportunities before customers churn.',
          'Understanding which products match member goals.',
          'Improving offers and subscription decisions.',
          'Building a stronger retention experience instead of relying only on new acquisition campaigns.',
        ],
        items_ar: [
          'معرفة المشتركين الأقل التزامًا.',
          'تحديد فرص التدخل قبل أن ينسحب العميل.',
          'فهم المنتجات الأكثر ارتباطًا بأهداف المشتركين.',
          'تحسين قرارات العروض والاشتراكات.',
          'بناء تجربة احتفاظ أفضل بدل الاعتماد فقط على حملات جذب جديدة.',
        ],
      },
    ],

    impactIntro_en: 'The solution helped the club turn membership from random attendance into a continuous digital journey that improves commitment and increases customer lifetime value.',
    impactIntro_ar: 'ساعد الحل النادي على تحويل تجربة الاشتراك من حضور عشوائي إلى رحلة رقمية مستمرة تزيد الالتزام وترفع القيمة الدائمة للعميل.',
    impactItems_en: [
      '45% increase in retention and subscription renewal rates.',
      '35% reduction in customer acquisition cost through referrals and positive member experience.',
      '60% increase in internal product and supplement sales.',
      'Less dependency on hard selling inside branches.',
      'Better member commitment through clear plans and smart reminders.',
      'Stronger feeling of personal attention and support.',
      'Trainers became able to support more members without heavy operational pressure.',
      'The app became an additional revenue channel for the club.',
      'Better management decisions based on commitment, engagement, and sales data.',
      'Loyal members became brand advocates through referrals and positive experience.',
    ],
    impactItems_ar: [
      'ارتفاع معدل الاحتفاظ بالعملاء وتجديد الاشتراكات بنسبة 45%.',
      'انخفاض تكلفة الاستحواذ على العميل بنسبة 35% بفضل الترشيحات وتجربة العملاء الإيجابية.',
      'زيادة مبيعات المنتجات والمكملات داخل النادي بنسبة 60%.',
      'تقليل اعتماد النادي على البيع الضاغط داخل الفروع.',
      'تحسين التزام المشتركين من خلال خطط واضحة وتذكيرات ذكية.',
      'رفع شعور المشترك بالاهتمام والمتابعة الشخصية.',
      'مساعدة المدربين على متابعة عدد أكبر من المشتركين دون ضغط تشغيلي كبير.',
      'تحويل التطبيق إلى قناة إيرادات إضافية للنادي.',
      'تحسين قرارات الإدارة بناءً على بيانات الالتزام، التفاعل، والمبيعات.',
      'تحويل المشتركين الملتزمين إلى سفراء للعلامة من خلال الترشيحات والتجربة الإيجابية.',
    ],

    whyMatters_en: 'This case shows that the biggest problem for sports clubs is not always attracting new members. It is helping existing members stay committed until they see real progress. When a member does not know where to start or cannot see clear progress, leaving or not renewing becomes easy. The solution was to build a digital experience that reduces confusion, guides the member step by step, and connects product recommendations to the member’s current goal. In this case, the app was not just a display tool. It became a retention and growth system: helping members stay committed, helping the club sell smarter, and increasing the lifetime value of each customer.',
    whyMatters_ar: 'هذه الدراسة توضّح أن مشكلة الأندية الرياضية لا تكون دائمًا في جذب مشتركين جدد، بل في مساعدة المشترك الحالي على الالتزام حتى يرى نتيجة حقيقية. عندما يشعر العميل أنه لا يعرف من أين يبدأ، أو لا يرى تقدمًا واضحًا، يصبح ترك الاشتراك أو عدم التجديد قرارًا سهلًا. لذلك كان الحل هو بناء تجربة رقمية تقلل الحيرة، توجه العميل خطوة بخطوة، وتربط توصيات المنتجات بهدفه الحالي. بهذا الشكل، لم يكن التطبيق مجرد وسيلة عرض، بل أصبح نظام احتفاظ ونمو: يساعد المشترك على الالتزام، يساعد النادي على البيع بشكل أذكى، ويزيد القيمة الدائمة لكل عميل.',

    relatedSolutions: [
      { title_en: 'Intelligence That Reveals Opportunities Early', title_ar: 'ذكاء يكشف الفرص مبكرًا', desc_en: 'Using member data to identify retention opportunities, product recommendations, and cases that need intervention.', desc_ar: 'استخدام بيانات المشتركين لاكتشاف فرص الاحتفاظ، التوصيات المناسبة، والحالات التي تحتاج تدخلًا.', href: '/solutions/ai-practical-decisions' },
      { title_en: 'Visits Turned into Trackable Requests', title_ar: 'زيارات تتحول إلى طلبات', desc_en: 'Turning in-app engagement into purchase requests for the right products at the right time.', desc_ar: 'تحويل تفاعل المشترك داخل التطبيق إلى عمليات شراء للمنتجات المناسبة في الوقت المناسب.', href: '/solutions/digital-experiences' },
      { title_en: 'Faster Decisions Without Guesswork', title_ar: 'قرار أسرع بدل التخمين', desc_en: 'Giving management data around commitment, engagement, renewals, and product sales.', desc_ar: 'توفير بيانات للإدارة حول الالتزام، التفاعل، التجديد، ومبيعات المنتجات.', href: '/solutions/visibility-insights' },
      { title_en: 'Growth Stage / Smart Retention', title_ar: 'Growth Stage / Smart Retention', desc_en: 'Improving retention, increasing lifetime value, and opening additional revenue channels inside the business.', desc_ar: 'تحسين الاحتفاظ بالعملاء، رفع القيمة الدائمة، وفتح قنوات إيرادات إضافية داخل النشاط.', href: '/solutions/growth' },
    ],

    cta: {
      title_en: 'Do your members stop showing up after the first months?',
      title_ar: 'هل تخسر مشتركين بعد أول شهرين من الاشتراك؟',
      desc_en: 'Tell us how you manage member experience, follow-up, and product sales inside your club — and we will help you identify the closest path to a digital experience that increases commitment and revenue.',
      desc_ar: 'شاركنا كيف تدير تجربة المشترك، المتابعة، ومبيعات المنتجات داخل ناديك — وسنساعدك على تحديد المسار الأقرب لبناء تجربة رقمية تزيد الالتزام والإيرادات.',
      button_en: 'Share your business challenge',
      button_ar: 'شارك تحدي عملك',
    },
  },
