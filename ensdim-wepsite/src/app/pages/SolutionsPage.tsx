...
const solutionCards = [
  { slug: 'follow-up-systems', en: { title: 'Follow-up that prevents lost opportunities', condition: 'You need this if you still rely on WhatsApp, Excel, or team memory to capture customers and follow up on opportunities.', roi: 'The main return is fewer lost leads, faster follow-up, and better conversion from inquiry to request.' }, ar: { title: 'متابعة تمنع ضياع الفرص', condition: 'تحتاجه إذا كنت ما زلت تعتمد على واتساب أو اكسيل أو ذاكرة الموظفين في تسجيل العملاء ومتابعة الفرص.', roi: 'العائد الأساسي هو تقليل العملاء الضائعين، تحسين سرعة المتابعة، ورفع التحويل من استفسار إلى طلب.' } },
  { slug: 'digital-experiences', en: { title: 'Visits that turn into clear requests', condition: 'You need this if your website, campaigns, or landing pages bring visitors but do not clearly turn them into requests or bookings.', roi: 'The main return is higher conversion, clearer customer journeys, and better return on marketing spend.' }, ar: { title: 'زيارات تتحول إلى طلبات', condition: 'تحتاجه إذا كان لديك موقع أو حملات أو صفحات هبوط تجلب زيارات، لكن لا تتحول بوضوح إلى طلبات أو حجوزات.', roi: 'العائد الأساسي هو رفع التحويل، تحسين وضوح رحلة العميل، وزيادة العائد من الإنفاق التسويقي.' } },
  { slug: 'visibility-insights', en: { title: 'Faster decisions instead of guessing', condition: 'You need this if you have sales, branches, campaigns, or daily data but cannot see the full picture at the right time.', roi: 'The main return is faster decisions, clearer performance visibility, and less dependence on delayed reports.' }, ar: { title: 'قرار أسرع بدل التخمين', condition: 'تحتاجه إذا كان لديك مبيعات، فروع، حملات، أو بيانات يومية، لكن لا ترى الصورة الكاملة في الوقت المناسب.', roi: 'العائد الأساسي هو قرارات أسرع، رؤية أوضح للأداء، وتقليل الاعتماد على التقارير المتأخرة.' } },
  { slug: 'automation-layers', en: { title: 'Lower cost and less pressure', condition: 'You need this if your team spends too much time on repeated tasks that could be organized or automated.', roi: 'The main return is less waste, lower team pressure, and less need to hire more people every time the business grows.' }, ar: { title: 'تكلفة أقل وضغط أقل', condition: 'تحتاجه إذا كان فريقك يستهلك وقتًا كبيرًا في مهام متكررة كان يمكن تنظيمها أو أتمتتها.', roi: 'العائد الأساسي هو تقليل الهدر، تخفيف ضغط الفريق، وخفض الحاجة للتوظيف الزائد مع كل نمو.' } },
  { slug: 'customer-journey-systems', en: { title: 'Scalable operations', condition: 'You need this if your business is growing, but operations still depend heavily on people, and every increase in demand creates more chaos.', roi: 'The main return is clear operating flows that can handle more customers, team members, branches, and requests.' }, ar: { title: 'تشغيل قابل للتوسع', condition: 'تحتاجه إذا بدأ نشاطك يكبر، لكن التشغيل لا يزال يعتمد على الأشخاص فقط، وكل زيادة في العملاء تضيف فوضى أكبر.', roi: 'العائد الأساسي هو تحويل التشغيل إلى مسارات واضحة تستطيع تحمل زيادة العملاء والفريق والفروع.' } },
  { slug: 'ai-practical-decisions', en: { title: 'Smart visibility that detects opportunities early', condition: 'You need this if you want your data to turn into practical signals that reveal drops and opportunities before it is too late.', roi: 'The main return is earlier discovery of opportunities, clearer management alerts, and better decisions based on real signals.' }, ar: { title: 'رؤية ذكية تكشف الفرص مبكرًا', condition: 'تحتاجه إذا كنت تريد أن تتحول البيانات إلى إشارات عملية تكشف الانخفاضات والفرص قبل فوات الوقت.', roi: 'العائد الأساسي هو اكتشاف فرص التحسين مبكرًا، تنبيه الإدارة، وتوجيه القرار بناءً على إشارات واضحة.' } },
];
...
const howWeChoose = [
  ...
  { en: { title: 'Design the solution path', desc: "We define what your business actually needs, whether that's follow-up, conversion, dashboards, automation, or scalable operations." }, ar: { title: 'نصمم مسار الحل', desc: 'نحدد ما يحتاجه نشاطك فعليًا، سواء كان متابعة، تحويل، لوحة بيانات، أتمتة، أو تشغيل قابل للتوسع.' } },
    ...
    <>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <ScrollReveal>
            ...
            <p className="text-sm text-[#4F555E] leading-relaxed">
              {ar
                ? 'كل حل يتم تصميمه حول طريقة عمل نشاطك الفعلية، من كيف يدخل العميل وأين تضيع المتابعة، إلى ما يستهلك وقت الفريق وما الرقم الذي تريد تحسينه.'
                : 'Each solution is designed around how your business actually works, from how customers enter and where follow-up is lost to what consumes your team’s time and which number you want to improve.'}
            </p>
          </ScrollReveal>
        </div>
      </section>
      ...
      <FAQSection
        ...
        faqs={ar ? [
          ...
          { question: 'كيف أعرف أن الحل سيحقق عائدًا؟', answer: 'نحدد قبل البناء الرقم الذي نريد تحسينه، سواء كان التحويل، سرعة الرد، تقليل الهدر، وضوح البيانات، أو ضغط الفريق، ثم نقيس التحسن بعد التنفيذ.' },
          ...
          { question: 'How do I know the solution will create a return?', answer: "Before building, we define the number we want to improve, whether that's conversion, response speed, reduced waste, data visibility, or team pressure, then measure the improvement after implementation." },
