...
const stageData: Record<'build' | 'start' | 'growth', { en: StageContent; ar: StageContent }> = {
  ...
  growth: {
    en: {
      ...
      ctaBody: 'Tell us where your data lives now, which process consumes the most team time, and which decision you need to see faster. We will help you define the right growth layer, whether data, automation, intelligence, security, or scalable operations.',
    ...
    ar: {
      ...
      ctaBody: 'شاركنا أين تتجمع بياناتك الآن، ما أكثر عملية تستهلك وقت فريقك، وما القرار الذي تحتاج أن تراه بشكل أسرع. سنساعدك على تحديد طبقة النمو المناسبة، سواء بيانات، أتمتة، ذكاء، أمان، أو تشغيل قابل للتوسع.',
