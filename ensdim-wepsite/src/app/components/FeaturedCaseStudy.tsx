            ...
            <div className="p-8 md:p-12 flex flex-col justify-center order-2 md:order-1">
              ...
              <div className="grid grid-cols-3 gap-3 mb-6 pb-6 border-b border-[#E5E5E5]">
                <div>
                  ...
                  <p className="text-sm text-[#101418] font-semibold">{t('caseStudy.problemText')}</p>
                </div>
                <div>
                  <p className="text-[10px] text-[#69717D] mb-1 uppercase tracking-wide">
                    {t('caseStudy.solutionLabel')}
                  </p>
                  <p className="text-sm text-[#101418] font-semibold">{t('caseStudy.solutionText')}</p>
                </div>
                <div>
                  <p className="text-[10px] text-[#69717D] mb-1 uppercase tracking-wide">
                    {t('caseStudy.impactLabel')}
                  </p>
                  <p className="text-sm text-[#101418] font-semibold">{t('caseStudy.impactText')}</p>
                </div>
              </div>

              <div className="flex flex-col sm:flex-row gap-3">
                <Link to="/case-studies/scattered-follow-up" className="inline-flex items-center gap-2 px-5 py-2.5 border border-[#E5E5E5] text-[#101418] rounded-xl hover:border-[#6D5DF6] hover:text-[#6D5DF6] transition-colors text-sm font-medium">
                  {t('caseStudy.cta')}
                  <ArrowRight size={16} />
                </Link>
