          ...
          <div className="flex-shrink-0 lg:w-[52%] max-w-[600px]">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-[#3B2A78] text-white rounded-xl hover:bg-[#4a3690] active:scale-[0.98] transition-all duration-200 text-sm sm:text-base font-semibold"
              >
