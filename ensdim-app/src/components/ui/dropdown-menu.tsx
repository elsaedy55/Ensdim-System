...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRight className="ms-auto h-4 w-4 text-(--text-muted) rtl:scale-x-[-1]" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      "text-(--text-primary) focus:bg-(--bg-muted) data-disabled:pointer-events-none data-disabled:opacity-50",
      className
    )}
    checked={checked}
    {...props}
