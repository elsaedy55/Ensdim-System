...
export function ProjectStatusHeroCard({ project, isLoading }: ProjectStatusHeroCardProps) {
  ...
  return (
    <div className={cn("surface p-6 transition-shadow hover:shadow-(--shadow-md)", isDelayed && "border-(--danger-muted)")}>
      {/* Header row */}
      <div className="flex items-start justify-between gap-4 mb-5 rtl:flex-row-reverse rtl:text-right">
      ...
      {/* Timeline */}
      <div className="flex flex-wrap items-center gap-x-6 gap-y-2 pt-4 border-t border-(--border) rtl:flex-row-reverse">
        <div className="flex items-center gap-2 text-sm rtl:flex-row-reverse rtl:text-right">
