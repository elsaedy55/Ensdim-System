...
// Scoped to (admin)/admin/ so a failed query in one section (e.g. projects)
// doesn't tear down the sidebar/header — the rest of the dashboard stays usable.
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 text-center px-4">
      ...
      <div className="flex gap-3">
        ...
        <Button variant="secondary" asChild>
          <a href={ROUTES.ADMIN.OVERVIEW}>{t("backHome")}</a>
        </Button>
      </div>
    </div>
  );
