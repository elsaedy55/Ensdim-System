...
// Data is prefetched server-side and hydrated into the query cache by
// dashboard/page.tsx — these hooks resolve from that cache on first paint
// instead of waiting on a client round-trip to Supabase, and transparently
// take over (refetch/refresh) as a normal client-side query afterwards.
