...
// Scoped to (client)/ so a failed query on one page doesn't tear down the
// client portal shell — the rest of the dashboard stays usable.
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 text-center px-4">
      ...
      <div className="flex gap-3">
        ...
        <Button variant="secondary" asChild>
          <a href={ROUTES.CLIENT.DASHBOARD}>{t("backHome")}</a>
        </Button>
      </div>
    </div>
  );
